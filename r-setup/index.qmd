---
title: "Installing R, accessing data in R"
format:
  html:
    include-after-body: checklist.html
---

[If your machine **is not** running MacOS, Windows 11 or higher, start from the [Posit Cloud](#posit-cloud) step]{.aside}
...
::: {.checklist}
- [ ] Create folder called `comm_106`
- [ ] Install R
- [ ] Install RStudio
- [ ] Create an R Markdown file called `practice_01.rmd` 
- [ ] Load a dataset into your working directory
:::
...
- [ ] Start a new project called `comm_106`
- [ ] Create an R Markdown file called `practice_01.rmd` 
- [ ] Load a dataset into your working directory
:::
